    ...
    <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <section className="mt-10 rounded-[16px] border border-brand-100 bg-brand-50 p-5 md:p-6">
        ...
        <p className="text-slate-700 leading-relaxed mb-4">
          GA4 事件包含 page_context_viewed、tool_started、tool_completed、content_shared、content_scroll_depth_reached、site_search_performed、site_search_result_clicked、cta_clicked、tool_next_step_clicked、newsletter_intent_submitted 與 checklist_print_clicked。
