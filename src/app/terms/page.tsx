    ...
    <div className="mx-auto w-full max-w-3xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="space-y-8 text-slate-700 leading-relaxed">
        <section>
          ...
          <p className="mt-3">
            本站不是政府機關、律師事務所、會計師事務所或人力資源顧問公司，也不提供個案代理、調解代理或法律文件撰寫服務。
            若頁面連到政府網站或法規資料庫，該連結僅供查證，不代表主管機關背書本站內容。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            使用者應自行核對薪資單、出勤紀錄、勞動契約、公司規章與主管機關最新公告。
            若本站資料與官方公告不一致，應以官方公告、法規文字、主管機關解釋與個案事實為準。
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            使用者不得以人工或自動化方式製造不正常流量、重複點擊廣告、鼓勵他人點擊廣告，或把廣告誤導成本站功能。
            若發現廣告內容不當、遮擋操作或疑似冒用官方名義，可透過聯絡頁回報。
          </p>
        </section>
