...
export const GUIDE_HUBS: GuideHub[] = [
  {
    ...
    articles: [
      ...
      { title: "月薪 38,000 實領多少？", href: "/articles/salary-38000-take-home" },
      { title: "月薪 40,000 實領多少？", href: "/articles/salary-40000-take-home" },
      { title: "月薪 42,000 實領多少？", href: "/articles/salary-42000-take-home" },
      { title: "月薪 45,000 實領多少？", href: "/articles/salary-45000-take-home" },
      { title: "月薪 50,000 實領多少？", href: "/articles/salary-50000-take-home" },
      { title: "月薪 55,000 實領多少？", href: "/articles/salary-55000-take-home" },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "平日加班 1.5 小時多少錢？", href: "/articles/overtime-1-5hours-calculation" },
      { title: "平日加班 2.5 小時多少錢？", href: "/articles/overtime-2-5hours-calculation" },
      { title: "平日加班 3 小時多少錢？", href: "/articles/overtime-3hours-calculation" },
      { title: "平日加班 4 小時多少錢？", href: "/articles/overtime-4hours-calculation" },
      { title: "國定假日加班 8 小時多少錢？", href: "/articles/holiday-overtime-8hours" },
      { title: "國定假日與例假日加班怎麼算？", href: "/articles/holiday-overtime-complete" },
      { title: "加班費爭議證據清單", href: "/articles/overtime-evidence-checklist" },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "工作 6 個月資遣費怎麼算？", href: "/articles/severance-6months" },
      { title: "工作 1 年資遣費怎麼算？", href: "/articles/severance-1year" },
      { title: "工作 1 年 6 個月資遣費怎麼算？", href: "/articles/severance-18months" },
      ...
      { title: "工作 4 年資遣費怎麼算？", href: "/articles/severance-4years" },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "離職前特休沒休完怎麼算？", href: "/articles/annual-leave-resignation-payout-example" },
  ...
  },
  {
    ...
    articles: [
      ...
      { title: "勞保低報怎麼申訴？", href: "/articles/labor-insurance-underreporting-complaint" },
